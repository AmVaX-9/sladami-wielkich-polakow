    ...
    return (
        <div className="container">
            ...
            <div id="regulamin" className="info-card">
                ...
                <p className="prize-text">Nagrody o wartości 450 PLN czekają!</p>
            ...
            <section id="kontakt" className="contact-section">
                ...
                <div className="contact-buttons">
                    <a
                        ...
                        className="btn-insta"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                        <span>@nie.przespij.jutra</span>
                    </a>
                    ...
                    <a
                        ...
                        className="btn-email"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="icon"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                        <span>nie.przespij.jutra@gmail.com</span>
                    </a>
                </div>
            </section>
